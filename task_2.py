...
def salary_dict(name_list, salary_list, extra_list):
    return {name: salary * (float(bonus.strip('%')) / 100) for name, salary, bonus in zip(name_list, salary_list, extra_list)}
...
# dict_salary = salary_dict(name_list, salary_list, extra_list)
print(salary_dict(name_list, salary_list, extra_list))